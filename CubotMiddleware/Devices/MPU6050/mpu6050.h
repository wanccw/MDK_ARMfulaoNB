...
#define GYRO_FILTER_NUM 30

#define Kpp 0.5f         //原始1.0f               // proportional gain governs rate of convergence to accelerometer/magnetometer
#define Kii 0.1f                     // integral gain governs rate of convergence of gyroscope biases
#define RtA 		57.324841f		//  180/3.1415  角度制 转化为弧度制	
#define Gyro_Gr		0.0005327f
typedef struct {
	int16_t x;
	int16_t y;
	int16_t z;
...
extern volatile uint32_t now; // 采样周期计数 单位 us
extern IMU_four imu_four;
extern SENSOR_StoreTypeDef sensor;
extern SENSOR_StoreTypeDef sensor2;
extern MPUAngle mpuAngle;
extern MPUAngle mpuAngle2;

//void PrepareForIMU(SENSOR_StoreTypeDef *sensor);
...
//uint8_t Gyro_OFFEST(SENSOR_StoreTypeDef *sensor,MPUAngle *mpuAngle);
uint8_t Gyro_OFFEST(SENSOR_StoreTypeDef *sensor,MPUAngle *mpuAngle,int offest_flag);

//void IMU_Boot(SENSOR_StoreTypeDef *sensor);
//void IMU_Boot(SENSOR_StoreTypeDef *sensor,MPUAngle *mpuAngle)	;
